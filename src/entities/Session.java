...
public class Session {
    ...
    // Constructeur
    public Session(LocalDate dateArrive, LocalTime heureArrive,
    ...
    public String toString() {
        return "Session{id=" + id + ", arrivee=" + dateArrive + " " + heureArrive +
               ", depart=" + dateDepart + " " + heureDepart +
               ", duree=" + calculerDuree() + "h" +
               ", enfant=" + (enfant != null ? enfant.getNom() : "non défini") + "}";
    }
}
